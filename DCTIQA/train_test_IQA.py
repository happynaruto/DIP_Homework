...
def main(config):
    ...
    folder_path = {
        'live': '/media/DATA3/swenb/dataset/LIVE/databaserelease2/',
        'csiq': '/media/DATA3/swenb/dataset/CSIQ/',
        'tid2013': '/media/DATA3/swenb/dataset/TID2013/tid2013/',
        'livec': '/media/DATA3/swenb/dataset/LIVEC/ChallengeDB_release/ChallengeDB_release/',
        'koniq-10k': '/media/DATA3/swenb/dataset/KonIQ-10k/',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', dest='dataset', type=str, default='live', help='Support datasets: livec|koniq-10k|bid|live|csiq|tid2013')
